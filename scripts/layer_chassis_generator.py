...
// Process validation featura, flags and settings specified through extensions, a layer settings file, or environment variables
...
// Process Validation Features flags specified through the ValidationFeatureEnable extension
